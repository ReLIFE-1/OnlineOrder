...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"10px 10px","margin":"0 auto 20px","borderRadius":"0","background":"#fff","width":"1200px","position":"relative","height":"100%"}'>
