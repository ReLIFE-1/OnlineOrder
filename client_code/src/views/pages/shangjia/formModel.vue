	...
	<div class="app-contain" :style='{"padding":"10px 10px","margin":"0 auto 20px","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","display":"flex","width":"1200px","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('shangjia','审核')" type="warning" @click="approvalClick()">审核</el-button>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			bannerList.value = res.data.data.yingyezhizhao?res.data.data.yingyezhizhao.split(','):[]
