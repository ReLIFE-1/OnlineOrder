        ...
        <div class="data_view">
          ...
          >
            <div
              class="data_img_box"
              v-if="
                item.yingyezhizhao && item.yingyezhizhao.substr(0, 4) == 'http'
              "
              @click.stop="preViewClick(item.yingyezhizhao)"
            >
              <el-image
                class="data_img"
                :src="item.yingyezhizhao"
                fit="cover"
              ></el-image>
            </div>
            <div
              ...
              v-else
              @click.stop="
                preViewClick($config.url + item.yingyezhizhao.split(',')[0])
              "
            >
              <el-image
                class="data_img"
                :src="
                  item.yingyezhizhao
                    ? $config.url + item.yingyezhizhao.split(',')[0]
                    : ''
                "
                fit="cover"
              ></el-image>
...
const detailClick = (id) => {
  router.push(
    'shangjiaDetail?id=' + id + (centerType.value ? '&&centerType=1' : '')
  )
}
//下载文件
const download = (file) => {
