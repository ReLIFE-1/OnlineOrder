    ...
    <div class="app-contain">
      <div class="list_search_view">
        ...
        <div class="btn_view">
          <el-button
            type="success"
            @click="addClick"
            v-if="btnAuth('discusscaipinxinxi', '新增')"
            >新增</el-button
          >
          <el-button
            type="primary"
            ...
            @click="editClick"
            v-if="btnAuth('discusscaipinxinxi', '修改')"
            >修改</el-button
          >
          <el-button
            type="danger"
      ...
      >
        ...
        >
          <template #default="scope">
            <el-button
              v-if="btnAuth('discusscaipinxinxi', '查看评论')"
              type="warning"
              @click="commentClick(scope.row.id)"
              >查看评论</el-button
            >
            <el-button type="warning" @click="replyClick(scope.row.id)"
              >回复</el-button
            >
          </template>
        </el-table-column>
