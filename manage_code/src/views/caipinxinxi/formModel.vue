    ...
    >
      ...
      >
        <el-row>
          <el-col :span="12">
            <el-form-item label="店铺名称" prop="dianpumingcheng">
              <el-input
                ...
                type="text"
                :readonly="
                  !isAdd || disabledForm.dianpumingcheng ? true : false
                "
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="菜品名称" prop="caipinmingcheng">
              <el-input
                ...
                type="text"
                :readonly="
                  !isAdd || disabledForm.caipinmingcheng ? true : false
                "
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item prop="caipintupian" label="菜品图片">
              <uploads
          ...
          <el-col :span="12">
            <el-form-item label="营养成分" prop="yingyangchengfen">
              <el-input
                ...
                type="text"
                :readonly="
                  !isAdd || disabledForm.yingyangchengfen ? true : false
                "
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="商家姓名" prop="shangjiaxingming">
              <el-input
                ...
                type="text"
                :readonly="
                  !isAdd || disabledForm.shangjiaxingming ? true : false
                "
              />
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="菜品祥情" prop="caipinxiangqing">
              <editor
                ...
                placeholder="请输入菜品祥情"
                :readonly="
                  !isAdd || disabledForm.caipinxiangqing ? true : false
                "
                class="list_editor"
...
const getInfo = () => {
  context
    ...
    .then((res) => {
      ...
      res.data.data.caipinxiangqing = res.data.data.caipinxiangqing
        ? res.data.data.caipinxiangqing.replace(
            reg,
            '../../../onlineOrder/file'
          )
        : ''
