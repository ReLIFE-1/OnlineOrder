        ...
        >
          <template #default="scope">
            <div v-if="scope.row.caipintupian">
              <el-image
                v-if="scope.row.caipintupian.substring(0, 4) == 'http'"
                preview-teleported
                :preview-src-list="[scope.row.caipintupian.split(',')[0]]"
                :src="scope.row.caipintupian.split(',')[0]"
              ...
              <el-image
                ...
                preview-teleported
                :preview-src-list="[
                  $config.url + scope.row.caipintupian.split(',')[0],
                ]"
                :src="$config.url + scope.row.caipintupian.split(',')[0]"
                style="width: 100px; height: 100px"
              >
              </el-image>
            </div>
