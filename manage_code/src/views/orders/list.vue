  ...
  <div>
    <div class="app-contain">
      ...
      <div class="list_search_view">
        ...
        <div class="btn_view">
          ...
          <el-button
            ...
            @click="editClick"
            v-if="
              btnAuth('orders' + (orderStatus ? '/' + orderStatus : ''), '修改')
            "
            >修改</el-button
          >
          <el-button
            ...
            @click="delClick(null)"
            v-if="
              btnAuth('orders' + (orderStatus ? '/' + orderStatus : ''), '删除')
            "
            >删除</el-button
          >
          <el-button
            ...
            @click="exportClick"
            v-if="
              btnAuth('orders' + (orderStatus ? '/' + orderStatus : ''), '导出')
            "
            >导出</el-button
          >
        </div>
      ...
      <el-table
        ...
        ref="table"
        v-if="
          btnAuth('orders' + (orderStatus ? '/' + orderStatus : ''), '查看')
        "
        :data="list"
        ...
        >
          <template #default="scope">
            <el-button
              v-if="
                btnAuth(
                  'orders' + (scope.row.status ? '/' + scope.row.status : ''),
                  '物流'
                )
              "
              type="warning"
